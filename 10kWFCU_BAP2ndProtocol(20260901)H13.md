# 10kWFCU BAP2nd Protocol — H13 (2026-09-01)

> **문서 버전:** H13 (고객 제출용)  
> **0x609 / 0x60A:** BMS_Debugging1 / BMS_Debugging2 — BMS Debugging Data (Undisclosed), 64bit  
> **물리계층:** CAN 2.0A Standard(11-bit ID) · LSB=intel · DLC 8byte  
> **검증:** 78 시그널 / 12 메시지, 오류 0건

---

## 📌 H11 → H13 변경사항

| No | ID | 항목 | H11 | H13 | IFCU 영향 |
|---|---|---|---|---|---|
| 1 | 0x602 | BMS_BATIC_Temp 신규 | (예약 D3) | bit48~63, 16bit, Signed, 0.1℃, −40~120 | 신호 추가만 (기존 파싱 영향 없음) |
| 2 | 0x608 | 카운터 3종 길이 | 8bit (bit0/16/32) | **16bit** (bit0/16/32) | **파싱 폭 8→16bit 수정 필요** |

> BMS_Slave1_Err(bit48)·BMS_Slave2_Err(bit56)는 8bit 유지. 0x609·0x60A는 BMS Debugging으로 변경 없음. 그 외 0x450·0x600·0x601·0x603~0x607 변경 없음.
...
| BSA | BSA9 | 0x608 | 8 | 100 | BMS_CANRxCount | 16 | 0 | LSB | Unsigned | 0 | 1 | 0 | 0 | 200 | Cnt |  | CANTxA = MailBoxRxCount (D0 워드 16bit) 전체 CAN Rx |  | R | T |  |
| BSA | BSA9 | 0x608 | 8 | 100 | BMS_CT_RxCount | 16 | 16 | LSB | Unsigned | 0 | 1 | 0 | 0 | 200 | Cnt |  | CANTxB = MailBox0RxCount (D1 워드 16bit) 전류센서 0x3C5 |  | R | T |  |
| BSA | BSA9 | 0x608 | 8 | 100 | BMS_VCU_RxCount | 16 | 32 | LSB | Unsigned | 0 | 1 | 0 | 0 | 200 | Cnt |  | CANTxC = MailBox2RxCount (D2 워드 16bit) IFCU 0x450 |  | R | T |  |
| BSA | BSA9 | 0x608 | 8 | 100 | BMS_Slave1_Err | 8 | 48 | LSB | Unsigned | 0 | 1 | 0 | 0 | 200 | Cnt |  | CANTxD = ComBine(Slave2,Slave1) 하위바이트 (byte6) Slave1 ISOSPI ERR |  | R | T |  |
| BSA | BSA9 | 0x608 | 8 | 100 | BMS_Slave2_Err | 8 | 56 | LSB | Unsigned | 0 | 1 | 0 | 0 | 200 | Cnt |  | CANTxD 상위바이트 (byte7) Slave2 ISOSPI ERR |  | R | T |  |
| BSA | BSA10 | 0x609 | 8 | 100 | BMS_Debugging1 | 64 | 0 | LSB | Unsigned | 0 | 1 | 0 | 0 | 0 | - |  | BMS Debugging Data (Undisclosed) |  | R | T |  |
| BSA | BSA11 | 0x60A | 8 | 100 | BMS_Debugging2 | 64 | 0 | LSB | Unsigned | 0 | 1 | 0 | 0 | 0 | - |  | BMS Debugging Data (Undisclosed) |  | R | T |  |
