# 10kWFCU BAP2nd Protocol — H14 (2026-09-10)
...
| No | ID | 항목 | H13 | H14 | FCU 영향 |
|---|---|---|---|---|---|
| 1 | 0x603 | `BSA_Prtct_PackISO_ERR` (CAN35) | 정의만 존재 (항상 0) | **판정 구현** — isoSPI 통신 실패 시 세트 | 비트 위치 변경 없음, **동작 신호로 활성화** |
| 2 | 0x608 | 메시지 구분 | 상세 신호 수록 | **BMS Debugging (Undisclosed, 64bit)** — 당사 내부 진단용 | 파싱 불필요 |

> 그 외 0x450 · 0x600 ~ 0x607 · 0x609 · 0x60A 변경 없음.
...
| IFCU | IFCU_BSA | 0x450 | 8 | 100 | Ifcu_BSAReset | 1 | 9 | LSB | Unsigned | 0 | 1 | 0 | 0 | 1 | flag | 0x0=Nor<br>0x1=Reset; | 0:BSA No Action, 1: BSA Fault Reset |  | T | R |  |
...
| BSA | BSA4 | 0x603 | 8 | 100 | BSA_Prtct_PackISO_ERR | 1 | 35 | LSB | Unsigned | 0 | 1 | 0 | 0 | 1 | flag | 0x0=Nor;<br>0x1=Prt; | SystemProtect_BIT.PackISO_ERR (CAN35/int19) — isoSPI 통신 에러. 판정: ltc_state==0 또는 ltc_error_count>200 시 세트 |  | R | T | ★[R14] 펌웨어 판정 로직 구현 (R13까지 정의만 존재, 항상 0) |
